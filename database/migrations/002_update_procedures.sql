-- ============================================================
-- Migración: Actualizar procedimientos almacenados
-- Fecha: 2026-04-14
-- Descripción: Actualiza procedimientos eliminar_reparacion y cerrar_orden
-- ============================================================

USE neveras_db;

-- ------------------------------------------------------------
-- 1. Actualizar procedimiento enviar_reparacion
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 2. Actualizar procedimiento cerrar_orden
-- ------------------------------------------------------------
